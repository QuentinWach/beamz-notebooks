...
| [3D Slap Waveguide](./3d_wg.ipynb) | ![3D Slap Waveguide](./imgs/3d_wg_design.png) | Finding the modes of a slap waveguide in 3D, calculating the effective index, and FDTD. | [Quentin Wach](https://github.com/QuentinWach) |
